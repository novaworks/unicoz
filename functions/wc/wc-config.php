<?php
if ( ! function_exists( 'unicoz_add_extra_hook_to_product_item' ) ) :
  function unicoz_add_extra_hook_to_product_item(){
...
add_action('kitify/products/before_render', 'unicoz_add_extra_hook_to_product_item' );

if ( ! function_exists( 'unicoz_add_grid_list_display' ) ) :
function unicoz_add_grid_list_display() {
...
if ( !function_exists('unicoz_add_toolbar_open')):
function unicoz_add_toolbar_open(){
...
if ( !function_exists('unicoz_add_toolbar_close')):
function unicoz_add_toolbar_close(){
    if(wc_get_loop_prop('kitify_loop_allow_extra_filters')){
      ...
      if(!empty($per_page_array)):
        ...
        echo '<label>'.esc_html__( 'Show','unicoz' ).'</label>';
        echo '<ul>';
        $active_a = '';
...
if ( !function_exists('unicoz_setup_toolbar')):
function unicoz_setup_toolbar(){
