...
Kirki::add_field( 'unicoz', array(
    ...
    'label'       => esc_html__( 'Layout Width', 'unicoz' ),
    'section'     => $section,
    'default'     => 'boxed',
    'priority'    => 10,
    'choices'     => array(
        'wide'  => esc_html__( 'Wide', 'unicoz' ),
        'boxed'  => esc_html__( 'Boxed', 'unicoz' ),
    ),
) );
...
Kirki::add_field( 'unicoz', array(
    ...
    'label'       => esc_html__( 'Shop Sidebar', 'unicoz' ),
    'section'     => $section,
    'default'     => true,
    'priority'    => 10,
) );
...
Kirki::add_field( 'unicoz', array(
    ...
    'label'       => esc_html__( 'Shop Filters', 'unicoz' ),
    'section'     => $section,
    'default'     => true,
    'priority'    => 10,
    'active_callback'    => array(
...
Kirki::add_field( 'unicoz', array(
    ...
    'label'       => esc_html__( 'Widget Scrollbar Max Height', 'unicoz' ),
    'section'     => $section,
    'default'     => 150,
    'priority'    => 10,
    'choices'     => array(
...
Kirki::add_field( 'unicoz', array(
    ...
    'label'       => esc_html__( 'Number of Columns on Mobile', 'unicoz' ),
    'section'     => $section,
    'default'     => 2,
    'priority'    => 10,
    'choices'     => array(
