	...
	class Nova_OP {
		...
		private static function theme_defaults() {
			return [
				...
				'popup_show_again_text' 			=> esc_html__( 'Don’t show this popup again', 'unicoz' ),
				...
				'secondary_font' 						=> array('font-family' => 'Bellefair', 'variant' => '600', 'subsets' => array('latin')),
				...
				'site_link_hover_color'				=> '#C49863',
				'primary_button_color'				=> '#242424',
				'secondary_button_color'			=> '#C49863',
				...
				'sale_page_title'                   	=> esc_html__( 'On Sale!', 'unicoz' ),
				'sale_page_badge_text'              	=> esc_html__( 'Sale!', 'unicoz' ),
				'new_products_page'                 	=> true,
				'new_products_page_slug'            	=> 'new-products',
				'new_products_page_title'           	=> esc_html__( 'New Products', 'unicoz' ),
				'new_products_badge_text'           	=> esc_html__( 'New!', 'unicoz' ),
				...
				'facebook_link' 						=> '#',
				'twitter_link' 							=> '#',
				'nav_button_title'						=> esc_html__( 'Browse Categories', 'unicoz' ),
